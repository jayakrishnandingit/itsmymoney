(function ($) {
    ...
    function bindData(template, data) {
        ...
        processElements("data-id", template, data, function ($elem, value) {
            $elem.attr("id", applyFormatters($elem, value, "id"));
        });

        processElements("data-class-append", template, data, function ($elem, value) {
            $elem.addClass(applyFormatters($elem, value.toString(), "class"));
        });        
